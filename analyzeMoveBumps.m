...
%%% Kinematic decoders %%%
modelParams.out_signals = {'vel_0_5',1:2;'vel','all';'force',1:2};
...
plot(abs(act2act_kinPred(:,3:4)),abs(pas2act_kinPred(:,3:4)),'.'); hold on; line([-30 30],[-30 30])
axis equal

figure; 
plot(abs(act2act_kinPred(:,3:4)),abs(comb2act_kinPred(:,3:4)),'.'); hold on; line([-30 30],[-30 30])
axis equal

figure; 
plot(abs(vel_act),abs(pas2act_kinPred(:,3:4)),'.'); hold on; line([-30 30],[-30 30])
axis equal

figure; 
plot(abs(fracVel_pas),abs(act2pas_kinPred(:,1:2)),'.'); hold on; line([-3 3],[-3 3])
axis equal
